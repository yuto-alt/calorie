...
const Direction = () => {
    ...
    const fetchRouteData = async () => {
     ...
     const apiKey =  GOOGLE_MAPS_API_KEY// 取得済みのAPIキー
      console.log(apiKey)
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <Marker coordinate={{ latitude: 35.6895, longitude: 139.6917 }} title="出発地点" />
          <Marker coordinate={{ latitude: 35.6586, longitude: 139.7454 }} title="目的地" />
        </MapView>
